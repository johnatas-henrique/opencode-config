...
- Each prototype lives in its own subdirectory: `docs/prototypes/[name]/`
...
- No production code may reference or import from `docs/prototypes/`
- Prototypes must not modify files outside `docs/prototypes/`
