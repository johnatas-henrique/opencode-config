...
2. **Gather context**:
   - Read relevant design docs in `docs/design/gdd/` for the feature
   - Read the sound bible at `docs/design/gdd/sound-bible.md` if it exists
...
5. **Save to** `docs/design/gdd/audio-[feature].md`.
