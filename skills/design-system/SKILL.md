...
- **Game concept**: Read `docs/design/gdd/game-concept.md` — fail if missing:
  > "No game concept found. Run `/brainstorm` first."
- **Systems index**: Read `docs/design/gdd/systems-index.md` — fail if missing:
...
- **Game pillars**: Read `docs/design/gdd/game-pillars.md` if it exists
- **Existing GDD**: Read `docs/design/gdd/[system-name].md` if it exists (resume, don't
  restart from scratch)
- **Related GDDs**: Glob `docs/design/gdd/*.md` and read any that are thematically related
...
- Update the target system's row:
  ...
  - Design Doc: link to `docs/design/gdd/[system-name].md`
- Update the Progress Tracker counts

Ask: "May I update the systems index at `docs/design/gdd/systems-index.md`?"
