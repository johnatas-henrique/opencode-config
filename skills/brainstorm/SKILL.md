...
2. **Check for existing concept work**:
   - Read `docs/design/gdd/game-concept.md` if it exists (resume, don't restart)
   - Read `docs/design/gdd/game-pillars.md` if it exists (build on established pillars)
...
5. **Save to** `docs/design/gdd/game-concept.md`, creating directories as needed.
...
6. **Suggest next steps** (in this order — this is the professional studio
   ...
   - "Use `/design-review docs/design/gdd/game-concept.md` to validate completeness"
