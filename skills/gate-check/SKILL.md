...
**Required Artifacts:**
- [ ] `docs/design/gdd/game-concept.md` exists and has content
- [ ] Game pillars defined (in concept doc or `docs/design/gdd/game-pillars.md`)
...
**Required Artifacts:**
- [ ] Systems index exists at `docs/design/gdd/systems-index.md` with at least MVP systems enumerated
- [ ] At least 1 GDD in `docs/design/gdd/` (beyond game-concept.md and systems-index.md)
...
- [ ] All core mechanics from GDD are implemented (cross-reference `docs/design/gdd/` with `src/`)
...
- Compare `docs/design/gdd/` documents against `src/` implementations
