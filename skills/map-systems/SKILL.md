...
**Required:**
- Read `docs/design/gdd/game-concept.md` — **fail with a clear message if missing**:
  > "No game concept found at `docs/design/gdd/game-concept.md`. Run `/brainstorm` first
  > to create one, then come back to decompose it into systems."

**Optional (read if they exist):**
- Read `docs/design/gdd/game-pillars.md` — pillars constrain priority and scope
- Read `docs/design/gdd/systems-index.md` — if exists, **resume** from where it left off
  (update, don't recreate from scratch)
- Glob `docs/design/gdd/*.md` — check which system GDDs already exist
...
Ask: "May I write the systems index to `docs/design/gdd/systems-index.md`?"
