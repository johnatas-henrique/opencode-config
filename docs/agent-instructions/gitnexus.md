...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/<nome_do_repo>/context` | Codebase overview, check index freshness |
| `gitnexus://repo/<nome_do_repo>/clusters` | All functional areas |
| `gitnexus://repo/<nome_do_repo>/processes` | All execution flows |
| `gitnexus://repo/<nome_do_repo>/process/{name}` | Step-by-step execution trace |
