...
Plans in English, docs/plans/YYYY-MM-DD-name.md format.
Code and plans in English, respond in user's language.
Minimum code that solves the problem.
Use strict: true in TypeScript/configs.
Use Execution table with real timestamps.
